...
function BentoGridItem({
  ...
  return (
    ...
    >
      <div className="absolute -right-1/2 top-0 z-0 size-full cursor-pointer bg-[linear-gradient(to_right,#3d16165e_1px,transparent_1px),linear-gradient(to_bottom,#3d16165e_1px,transparent_1px)] bg-[size:20px_20px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
...
function BentoGrid({ children, className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div className={cn("mx-auto max-w-6xl px-4 py-12", className)} {...props}>
      <motion.div
        className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-6"
        variants={containerVariants}
        initial="hidden"
...
export { BentoGrid, BentoGridItem, BentoGrid1, type BentoGridItemProps };
